...
const datapipe_experiment_id = "YLysMqiZwMbT"; // こっちは本実験用
...
const intro = {
    ...
    stimulus: `
      ...
      <p style="font-size: 20px">評価の際、前者（助詞・助動詞）の場合はその単語を文末表現として用いた言い方を想像してください</p>
      ...
      <p style="font-size: 20px">また、後者（感動詞）の単独提示における刺激は以下の通りです</p>
